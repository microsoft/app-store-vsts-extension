...
let myAnswers: string = `{
    ...
    "exec": {
        ...
        "fastlane deliver --force -u creds-username -a com.microsoft.test.appId -i mypackage.ipa -j ios --skip_metadata true --skip_screenshots true --submission_information '{'add_id_info_uses_idfa': true}'": {
            "code": 0,
