...
let myAnswers: string = `{
    ...
    "exec": {
        ...
        "fastlane deliver --force -u creds-username -a com.microsoft.test.appId -i mypackage.ipa -j appletvos --skip_metadata true --skip_screenshots true --submit_for_review true": {
            "code": 0,
