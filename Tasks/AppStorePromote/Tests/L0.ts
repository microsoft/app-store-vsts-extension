...
describe('app-store-promote L0 Suite', function () {
  ...
  it('additional fastlane arguments', async () => {
    ...
    assert(
      ...
      'should have run fastlane deliver with additional fastlane arguments.'
    );
    assert(
      tr.stdOutContained('##vso[task.debug]   2.1.5'),
  ...
  it('individual api key with deliver (no issuer_id)', async () => {
    this.timeout(1000);

    let tp = path.join(__dirname, 'L0IndividualApiKeyDeliver.js');
    let tr: ttm.MockTestRunner = new ttm.MockTestRunner(tp);
    const tempPath = 'test_temp_path';
    const keyFileName = 'api_keyD383SF739.json';
    const keyFilePath = path.join(tempPath, keyFileName);
  ...
  it('app specific password', async () => {
    ...
    assert(
      tr.succeeded,
      'task should have succeeded Stdout: [' + tr.stdout + '] err[' + tr.stderr + ']'
    );
    assert(
  ...
  it('latest build', async () => {
    ...
    assert(
      ...
      'fastlane deliver with the latest build should have been run.'
    );
    assert(
      tr.invokedToolCount === 3,
      'should have run gem install, gem update and fastlane deliver.'
  ...
  it('should auto release', async () => {
    ...
    assert(
      ...
      'fastlane deliver with auto release should have been run.'
    );
    assert(
      tr.invokedToolCount === 3,
      'should have run gem install, gem update and fastlane deliver.'
  ...
  it('team id', async () => {
    ...
    assert(
      ...
      'fastlane deliver with team id should have been run.'
    );
    assert(
      tr.invokedToolCount === 3,
      'should have run gem install, gem update and fastlane deliver.'
  ...
  it('team name', async () => {
    ...
    assert(
      ...
      'fastlane deliver with team name should have been run.'
    );
    assert(
      tr.invokedToolCount === 3,
      'should have run gem install, gem update and fastlane deliver.'
  ...
  it('team id and team name', async () => {
    ...
    assert(
      ...
      'fastlane deliver with team id and team name should have been run.'
    );
    assert(
      tr.invokedToolCount === 3,
      'should have run gem install, gem update and fastlane deliver.'
  ...
  it('build number', async () => {
    ...
    assert(
      ...
      'fastlane deliver with build number should have been run.'
    );
    assert(
      tr.invokedToolCount === 3,
      'should have run gem install, gem update and fastlane deliver.'
