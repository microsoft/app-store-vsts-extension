...
let myAnswers: string = `{
    ...
    "exec": {
        ...
        "fastlane deliver --force -u creds-username -a com.microsoft.test.appId -i mypackage.ipa -j ios --skip_metadata true --skip_screenshots true --automatic_release false -args someadditioanlargs": {
            "code": 0,
